##############################    3
#功能：得到地面的地图(有障碍物即黑色的标为1，白色标为0)
#输入：result文件夹中2500张照片
#输出：data文件夹中的map1.txt
...
'''
def Writedata(data):
    np.savetxt("data/map1.txt",data,fmt='%d',delimiter=' ')
    print("map1.txt已经生成，可在data文件夹中查看")
