###################################  5
#功能：对筛选出来的表格（2.xlsx****130条数据）进行处理并将提取出来的数据存入到一个330*5的二维数组中
#(x,y,h,隐私类型，对应在地图中的打标签的块的数字)、隐私类型1234）
#输入：data/maplabel.txt、2.xlsx
#输出：data/exc.txt
...
np.savetxt("data/exc.txt",buildings,fmt='%d',delimiter=',')
print("\n exc.txt已经生成，可在data文件夹中查看")